 ...
 * @return void
 */
function orangepop_register_block_patterns() {
	$block_pattern_categories = array(
		'featured' => array( 'label' => __( 'Featured', 'orangepop' ) ),
		'footer'   => array( 'label' => __( 'Footers', 'orangepop' ) ),
		'header'   => array( 'label' => __( 'Headers', 'orangepop' ) ),
		'query'    => array( 'label' => __( 'Query', 'orangepop' ) ),
		'pages'    => array( 'label' => __( 'Pages', 'orangepop' ) ),
	);
	 ...
	 * }
	 */
	$block_pattern_categories = apply_filters( 'orangepop_block_pattern_categories', $block_pattern_categories );
	 ...
	 */
	$block_patterns = apply_filters( 'orangepop_block_patterns', $block_patterns );

	foreach ( $block_patterns as $block_pattern ) {
		$pattern_file = get_theme_file_path( '/inc/patterns/' . $block_pattern . '.php' );

		register_block_pattern(
			'orangepop/' . $block_pattern,
			require $pattern_file
		);
	}
}
add_action( 'init', 'orangepop_register_block_patterns', 9 );
